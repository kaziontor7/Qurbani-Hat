...
import Hero from "@/app/assets/heroimg.png";
  ...
  return (
    <div>
      <div className="flex items-center bg-[#F4F4EC] md:py-20 py-10 md:px-6 px-3 gap-10 flex-col md:flex-row">
        ...
        <div className="">
          <Image src={Hero} alt="A Cow" className="rounded-lg border-7 border-white drop-shadow-lg" width={592} height={444} />
        </div>
      </div>
      <div className="md:py-16 py-8 md:px-6 px-3">
        <h2 className="font-bold text-3xl dark ">Featured Listings</h2>
        <p className="light-dark pt-1.75 pb-8">Verified health and premium quality.</p>
        <div>
          {/* Featured listing items would go here */}
        </div>
      </div>
